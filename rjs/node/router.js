...
router.put('/file/:filename', function(request, response) {
...
router.get('/execute/:filename', function(request, response) {
    // console.log(request.query);
    // console.log(request.params);
    // console.log(request.body);
...
router.get('/is_runnable/:filename', function(request, response) {
    // console.log(request.query);
    // console.log(request.params);
    // console.log(request.body);
...
router.delete('/file/:filename', function(request, response) {
    // console.log(request.query);
    // console.log(request.params);
    // console.log(request.body);
